...
class WeatherDetailViewFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.getNewWeather(args.cityName)
        binding.searchingField.visibility = View.GONE
        binding.submitButton.visibility = View.GONE

        binding.toFiveDayWeatherButton.setOnClickListener {
            val action =
                WeatherDetailViewFragmentDirections.actionWeatherDetailViewFragmentToXWeatherFragment(
                    args.cityName
                )
    ...
    override fun onResume() {
        super.onResume()
        (activity as AppCompatActivity).supportActionBar?.title = "Weather detail view"
    }
